...
const blankForm = () => ({ clientId: '', companyId: '', title: '', destination: '', bookingDate: today(), travelStartDate: '', nights: 1, travelEndDate: '', passengerCount: 1, status: 'DRAFT', clientNotes: '', changeNote: '', serviceItems: [blankItem()] })
